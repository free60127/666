export const CATEGORIES = ['pickup-food', 'pickup-parcel', 'sell-item', 'request-info', 'other'];
...
export const TASK_SELECT =
  ...
  't.deadline, t.status, t.category, t.taker_id, t.created_at, t.updated_at, t.completed_at, t.confirmed_at, t.confirmed_by, t.auto_confirmed_at, t.cancelled_at, t.cancel_reason, ' +
...
export const mapTask = (r) => r ? ({
  ...
  reward: r.reward, pickup: r.pickup, dropoff: r.dropoff, contact: r.contact, category: r.category || 'other',
